...
export const InstagramSocial = () => {
    return (
        <Link href="https://www.instagram.com/moneysigneric">
            <div className="cursor-pointer select-none bg-gradient-to-tr from-[#ffb951] via-pink-500 to-purple-500 border-[2.5px] sm:border-[4px] border-[#833cca] w-[18rem] sm:w-[20rem] h-[10rem] sm:h-[12rem] rounded-[25px] text-[#fff] flex flex-col justify-evenly hover:scale-[1.02] transition-[200ms]">
                <div className="mx-[0.5rem] inline-flex items-center">
                    <FontAwesomeIcon icon={faInstagram} className="h-[2.5rem] mr-[0.5rem]" />
                    <h1 className="text-[24px] tracking-[2px] font-[500]">Instagram</h1>
                </div>
